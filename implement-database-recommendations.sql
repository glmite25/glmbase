...
-- Church unit validation constraint
...
ALTER TABLE public.members ADD CONSTRAINT valid_church_unit 
    CHECK (churchunit IS NULL OR churchunit IN ('3HMedia', '3HMusic', '3HMovies', '3HSecurity', 'Discipleship', 'Praise Feet', 'Cloven Tongues'));
